...
def color_choice(win, canvas_width, margin, r, g, b):
  ...
  color_text = Text(Point(margin + margin + canvas_width + 410, 54),
                    "RGB Color")
  color_text._reconfig('font', ('Manaspace Regular', 14))
  color_text.setTextColor(color_rgb(0, 0, 0))
  
  color_box = Rectangle(Point(margin + margin + canvas_width + 340, 64),
                        Point(margin + margin + canvas_width + 480, 96))
  color_box.setFill(color_rgb(r, g, b))
  color_box.setOutline(color_rgb(r, g, b))

  color_entry = Entry(Point(margin + margin + canvas_width + 410, 80), 12)
  color_entry.setText("70,130,180")
